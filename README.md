# Selefra Provider Zendesk

Use this repo as a raw reference to **tables and schema** for Zendesk usage. [Here's](https://github.com/selefra/selefra-provider-zendesk/blob/main/docs/tables/zendesk.md) a summary of full coverage. 
